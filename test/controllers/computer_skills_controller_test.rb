...
class ComputerSkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer_skill" do
    assert_difference('ComputerSkill.count') do
      post computer_skills_url, params: { computer_skill: { computer_skill_list_id: @computer_skill.computer_skill_list_id, profile_id: @computer_skill.profile_id, skill_level_id: @computer_skill.skill_level_id } }
    end
  ...
  test "should update computer_skill" do
    patch computer_skill_url(@computer_skill), params: { computer_skill: { computer_skill_list_id: @computer_skill.computer_skill_list_id, profile_id: @computer_skill.profile_id, skill_level_id: @computer_skill.skill_level_id } }
