class EducationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education.save
        format.html { redirect_to [current_profile, @education], notice: 'Education was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @education.update(education_params)
        format.html { redirect_to [current_profile, @education], notice: 'Education was successfully updated.' }
  ...
  def destroy
    @education.destroy
    respond_to do |format|
      format.html { redirect_to profile_educations_url, notice: 'Education was successfully destroyed.' }
